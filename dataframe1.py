...
df=pd.dataframe(data=exp, column=['year of experience','Salary'])
print(df)

plt.plot(df['year of experience'],df['Salary'],color='red',linestyle='dotted', linewidth=2, marker='o', mrkerfacecolor='blue',markersize=5)
